...
export const LightBulbIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-4.665a5.98 5.98 0 0 0-1.5-4.665M12 18v-5.25a6.01 6.01 0 0 1-1.5-4.665A5.98 5.98 0 0 1 12 3.085m0 9.665A5.98 5.98 0 0 1 13.5 9m-1.5 4.665A5.98 5.98 0 0 0 10.5 9m3.75 6.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
    </svg>
);
